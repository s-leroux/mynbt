""" Anvil files are collections of NBT data packed in a single
...
#     following constents in their own namespace (or in the Anvil class?)
#
...
# Errors
# ====================================================================
class AnvilError(MyNBTError):
    """ Base class for all errors issued by the Anvil class
    """
    pass

class BadChunkError(AnvilError):
...
# Warnings
# ====================================================================
class AnvilWarning(MyNBTWarning):
    """ Base class for all warnings issued by the Anvil class
    """
    pass

class BadChunk(AnvilWarning):
...
class DuplicatePage(AnvilWarning):
